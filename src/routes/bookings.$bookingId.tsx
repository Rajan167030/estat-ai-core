...
export const Route = createFileRoute("/bookings/$bookingId")({
  ...
  head: ({ params }) => ({
    meta: [
      ...
      {
        name: "description",
        content: `Booking ${params.bookingId}: unit, value, payment schedule, documents, channel partner commission and approval history.`,
      },
      { property: "og:title", content: `Booking #${params.bookingId} — Estatum ERP` },
      {
        property: "og:description",
        content: "Booking detail with payment schedule, documents and commission.",
      },
    ...
    <AppShell>
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-3">
        <SectionCard
          ...
          description="Customer, unit and attribution"
        ...
        <SectionCard title="Channel partner commission" description="Payable after approval">
          {commission ? (
            ...
            <p className="text-sm text-muted-foreground">
              Direct booking — no channel partner commission applies.
            </p>
          )}
        </SectionCard>
      </div>
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-2">
        <SectionCard
          ...
          description="Milestone-linked demands"
          bodyClassName="p-0"
        >
          <DataTable
            head={
        ...
        <SectionCard title="Documents" description="Verification status for this customer">
          {docs.length === 0 ? (
            <p className="text-sm text-muted-foreground">
              No documents uploaded yet for this booking.
            </p>
          ) : (
